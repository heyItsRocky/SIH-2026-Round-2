...
### 1. Research
- **Where:** your project's research folders — `01_IDEA_1_MINE_SUBSIDENCE/02_RESEARCH/` or `02_IDEA_2_HIGH_ALTITUDE_ANTI_DRONE/02_DOMAIN_RESEARCH/` (and `03_ENVIRONMENTAL_ROBUSTNESS/`, `04_SOLUTION_EXPLORATION/` for Idea 2).
...
### 4. Documentation
- **Where:** the project's design folders — `01_.../03_SOLUTION_DESIGN/`, `02_.../05_SYSTEM_ARCHITECTURE/` (once created).
...
### 5. Implementation
- **Where:** the project's build folders — `01_.../04_HARDWARE/`, `01_.../05_SOFTWARE_AI/`, `02_.../06_PROTOTYPE/` (created when build begins). Shared code goes in `03_SHARED_TECH/`.
